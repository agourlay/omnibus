...
Omnibus needs to persist events in order to be able to replay them later. 

[Cassandra](http://cassandra.apache.org/) has been chosen as main database for its performance.
